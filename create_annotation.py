...
IMAGE_DIR = "/data/lhyman6/data/images/"  # Directory containing images
...
def main():
    ...
    annotations = generate_annotations(df, prompt, IMAGE_DIR, ASSISTANT_COL, IMAGE_COL)
    ...
    print("Annotation creation completed successfully.")
